...
def success_rate(
    prediction: Union[int, str, pd.Series, np.integer], y: Union[np.ndarray, pd.DataFrame]
) -> Union[float, pd.Series]:
    """
    ...
    Parameters
    ----------
    prediction: Union[float, int, str, pd.Series, np.integer]
...
def calc_classification_criterion(
    ...
    prediction: Union[int, str, pd.Series, np.integer],
    y: Union[np.ndarray, pd.Series],
    **kwargs,
) -> Union[float, pd.Series]:
    """
    ...
    prediction: Union[int, str, pd.Series, np.integer]
        The label prediction, of one rule (int, or str) or of a set of rules (pd.Series), or
